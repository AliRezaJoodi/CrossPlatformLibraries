...
static inline void Seg7_Segments_InitAllPins(void){
    ...
    //WRITE_BIT(SEG7_B_PORT,  SEG7_B_BIT,  !SEG7_SEGMENTS_ACTIVATE);

    SET_BIT(SEG7_C_DDR, SEG7_C_BIT);
    //WRITE_BIT(SEG7_C_PORT,  SEG7_C_BIT,  !SEG7_SEGMENTS_ACTIVATE);

    SET_BIT(SEG7_D_DDR, SEG7_D_BIT);
    //WRITE_BIT(SEG7_D_PORT,  SEG7_D_BIT,  !SEG7_SEGMENTS_ACTIVATE);

    SET_BIT(SEG7_E_DDR, SEG7_E_BIT);
    //WRITE_BIT(SEG7_E_PORT,  SEG7_E_BIT,  !SEG7_SEGMENTS_ACTIVATE);

    SET_BIT(SEG7_F_DDR, SEG7_F_BIT);
    //WRITE_BIT(SEG7_F_PORT,  SEG7_F_BIT,  !SEG7_SEGMENTS_ACTIVATE);

    SET_BIT(SEG7_G_DDR, SEG7_G_BIT);
    //WRITE_BIT(SEG7_G_PORT,  SEG7_G_BIT,  !SEG7_SEGMENTS_ACTIVATE);
