...
static inline uint8_t Keypad4x4_GetPins_Mode1(void){
    ...
    WRITE_BIT(number, 0, GET_BIT(KEYPAD_R1_PIN, KEYPAD_R1_BIT));
    WRITE_BIT(number, 1, GET_BIT(KEYPAD_R2_PIN, KEYPAD_R2_BIT));
    WRITE_BIT(number, 2, GET_BIT(KEYPAD_R3_PIN, KEYPAD_R3_BIT));
    WRITE_BIT(number, 3, GET_BIT(KEYPAD_R4_PIN, KEYPAD_R4_BIT));
...
static inline uint8_t Keypad4x4_GetPins_Mode2(void){
    ...
    WRITE_BIT(number, 4, GET_BIT(KEYPAD_C1_PIN, KEYPAD_C1_BIT));
    WRITE_BIT(number, 5, GET_BIT(KEYPAD_C2_PIN, KEYPAD_C2_BIT));
    WRITE_BIT(number, 6, GET_BIT(KEYPAD_C3_PIN, KEYPAD_C3_BIT));
    WRITE_BIT(number, 7, GET_BIT(KEYPAD_C4_PIN, KEYPAD_C4_BIT));
