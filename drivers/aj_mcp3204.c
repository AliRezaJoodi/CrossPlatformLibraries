...
/********************************************************/
uint16_t AJ_MCP3204_ReadRaw(aj_mcp3204_t *mcp, aj_mcp3204_channel_t ch){
    uint8_t data1 = 0x00U;
    uint8_t data2 = 0x00U;
    ...
    AJ_MCP3204_SPI_TxRx(data1);
    data1 = AJ_MCP3204_SPI_TxRx(data2);    // Get MSB
    data2 = AJ_MCP3204_SPI_TxRx(0xFF);     // Get LSB
    AJ_MCP3204_CS_SetIdle(mcp);
