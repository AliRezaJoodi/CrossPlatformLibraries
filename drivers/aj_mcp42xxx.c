...
#define AJ_MCP42010_CMD_WRITE_POT0      0x11U
#define AJ_MCP42010_CMD_WRITE_POT1      0x12U
#define AJ_MCP42010_CMD_WRITE_ALL       0x13U
#define AJ_MCP42010_CMD_SHUTDOWN_POT0   0x21U
#define AJ_MCP42010_CMD_SHUTDOWN_POT1   0x22U
#define AJ_MCP42010_CMD_SHUTDOWN_ALL    0x23U
...
void AJ_MCP42xxx_WritePot0(aj_mcp42xxx_t *mcp, uint8_t count){
    ...
    AJ_MCP42xxx_SPI_Transfer(AJ_MCP42010_CMD_WRITE_POT0);
...
void AJ_MCP42xxx_WritePot1(aj_mcp42xxx_t *mcp, uint8_t count){
    ...
    AJ_MCP42xxx_SPI_Transfer(AJ_MCP42010_CMD_WRITE_POT1);
    AJ_MCP42xxx_SPI_Transfer(count);
...
void AJ_MCP42xxx_WriteAll(aj_mcp42xxx_t *mcp, uint8_t count){
    ...
    AJ_MCP42xxx_SPI_Transfer(AJ_MCP42010_CMD_WRITE_ALL);
    AJ_MCP42xxx_SPI_Transfer(count);
...
void AJ_MCP42xxx_ShutdownPot0(aj_mcp42xxx_t *mcp){
    ...
    AJ_MCP42xxx_SPI_Transfer(AJ_MCP42010_CMD_SHUTDOWN_POT0);
...
void AJ_MCP42xxx_ShutdownPot1(aj_mcp42xxx_t *mcp){
    ...
    AJ_MCP42xxx_SPI_Transfer(AJ_MCP42010_CMD_SHUTDOWN_POT1);
    AJ_MCP42xxx_SPI_Transfer(0x00U);
...
void AJ_MCP42xxx_ShutdownAll(aj_mcp42xxx_t *mcp){
    ...
    AJ_MCP42xxx_SPI_Transfer(AJ_MCP42010_CMD_SHUTDOWN_ALL);
    AJ_MCP42xxx_SPI_Transfer(0x00U);
