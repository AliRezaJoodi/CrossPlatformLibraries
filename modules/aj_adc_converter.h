...
#ifndef AJ_ADC_CONVERTER_INCLUDED
#define AJ_ADC_CONVERTER_INCLUDED
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_12Bit5V(uint16_t raw){
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_12Bit4V096(uint16_t raw){
    return raw;
}
 ...
 */
static inline uint32_t AJ_ADC_ConvertRawToMicroVolt_12Bit3V3(uint16_t raw){
 ...
 */
static inline uint32_t AJ_ADC_ConvertRawToMicroVolt_12Bit2V048(uint16_t raw){
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_10Bit5V(uint16_t raw){
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_10Bit4V096(uint16_t raw){
    return raw << 2;
}
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_10Bit2V56(uint16_t raw){
    return (raw * 5U) >> 1;
}
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_10Bit2V048(uint16_t raw){
    return raw << 1;
}
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_8Bit5V(uint8_t raw) {
 ...
 */
static inline uint16_t AJ_ADC_ConvertRawToMilliVolt_8Bit2V56(uint8_t raw) {
