...
#ifndef AJ_DAC_CONVERTER_INCLUDED
#define AJ_DAC_CONVERTER_INCLUDED
 ...
 */
static inline uint16_t AJ_DAC_ConvertMilliVoltToCount_12Bit4V096(uint16_t mv) {
 ...
 */
static inline uint16_t AJ_DAC_ConvertMicroVoltToCount_12Bit2V048(uint32_t uv) {
 ...
 */
static inline uint16_t AJ_DAC_ConvertMilliVoltToCount_10Bit5V(uint16_t mv) {
 ...
 */
static inline uint16_t AJ_DAC_ConvertMilliVoltToCount_10Bit4V096(uint16_t mv){
 ...
 */
static inline uint16_t AJ_DAC_ConvertMilliVoltToCount_10Bit3V3(uint16_t mv) {
 ...
 */
static inline uint16_t AJ_DAC_ConvertMilliVoltToCount_10Bit2V048(uint16_t mv){
 ...
 */
static inline uint8_t AJ_DAC_ConvertMilliVoltToCount_8Bit5V(uint16_t mv) {
 ...
 */
static inline uint8_t AJ_DAC_ConvertMilliVoltToCount_8Bit3V3(uint16_t mv) {
