...
/* Write Pins                                                                 */
/******************************************************************************/
static inline void AJ_GPIO_ModifyPin_Mask(const aj_gpio_reg_t *gpio, uint8_t clearmask, uint8_t setmask){
    AJ_BitReg_ModifyBit_Mask(gpio->port, clearmask, setmask);
}
