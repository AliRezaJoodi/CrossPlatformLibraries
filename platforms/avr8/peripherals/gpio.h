...
//*****************************************************************
static inline void GPIO_ConfigDirection(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pin, GPIO_Direction_t mode) {
    WriteBit_Reg8(gpio->ddr, pin, mode);
}

//*****************************************************************
static inline void GPIO_ConfigPull(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pin, GPIO_Pull_t mode) {
...
static inline void GPIO_WritePin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pin, uint8_t status) {
    WriteBit_Reg8(gpio->port, pin, status);
}

static inline void GPIO_Write2Pin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pos, uint8_t value) {
    Write2Bit_Reg8(gpio->port, pos, value);
}

static inline void GPIO_Write3Pin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pos, uint8_t value) {
    Write3Bit_Reg8(gpio->port, pos, value);
}

static inline void GPIO_Write4Pin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pos, uint8_t value) {
...
static inline void GPIO_SetPin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pin) {
...
static inline void GPIO_ClearPin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pin) {
...
static inline void GPIO_TogglePin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pin) {
...
static inline uint8_t GPIO_ReadPin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pos) {
    return GetBit_Reg8(gpio->pin, pos);
}

static inline uint8_t GPIO_Read2Pin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pos) {
    return Get2Bit_Reg8(gpio->pin, pos);
}

static inline uint8_t GPIO_Read3Pin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pos) {
    return Get3Bit_Reg8(gpio->pin, pos);
}

static inline uint8_t GPIO_Read4Pin(const GPIO_PortReg_t *gpio, GPIO_PinPos_t pos) {
