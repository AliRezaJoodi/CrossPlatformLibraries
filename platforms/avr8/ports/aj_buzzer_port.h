...
static inline void AJ_Buzzer_Pin_ConfigAsOutput(void){
    AJ_BitReg_SetBits_Mask(&AJ_BUZZER_DDR, AJ_BUZZER_MASK);
}

static inline void AJ_Buzzer_Pin_Set(void){
    AJ_BitReg_SetBits_Mask(&AJ_BUZZER_PORT, AJ_BUZZER_MASK);
}

static inline void AJ_Buzzer_Pin_Clear(void){
    AJ_BitReg_ClearBits_Mask(&AJ_BUZZER_PORT, AJ_BUZZER_MASK);
}
