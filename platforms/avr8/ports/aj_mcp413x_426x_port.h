...
static inline void AJ_MCP413x_426x_CS_ConfigAsOutput(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_SetBit_Mask(mcp->cs.ddr, mcp->cs.mask);
}

static inline void AJ_MCP413x_426x_CS_SetActive(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_ClearBit_Mask(mcp->cs.port, mcp->cs.mask);
}

static inline void AJ_MCP413x_426x_CS_SetIdle(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_SetBit_Mask(mcp->cs.port, mcp->cs.mask);
}

#if (AJ_MCP413X_426X_SHDN_USED == 1U)
static inline void AJ_MCP413x_426x_SHDN_ConfigAsOutput(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_SetBit_Mask(mcp->shdn.ddr, mcp->shdn.mask);
}

static inline void AJ_MCP413x_426x_SHDN_SetActive(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_ClearBit_Mask(mcp->shdn.port, mcp->shdn.mask);
}

static inline void AJ_MCP413x_426x_SHDN_SetIdle(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_SetBit_Mask(mcp->shdn.port, mcp->shdn.mask);
}
#endif

#if (AJ_MCP413X_426X_WP_USED == 1U)
static inline void AJ_MCP413x_426x_WP_ConfigAsOutput(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_SetBit_Mask(mcp->wp.ddr, mcp->wp.mask);
}

static inline void AJ_MCP413x_426x_WP_SetActive(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_ClearBit_Mask(mcp->wp.port, mcp->wp.mask);
}

static inline void AJ_MCP413x_426x_WP_SetIdle(aj_mcp413x_426x_t *mcp){
    AJ_BitReg_SetBit_Mask(mcp->wp.port, mcp->wp.mask);
}
#endif

static inline uint8_t AJ_MCP413x_426x_SPI_TxRx(uint8_t data){
