...
typedef enum{
	...
	AJ_USART_CR1_IDLEIE = USART_CR1_IDLEIE_Msk, /*< Idle line detected interrupt enable */
	AJ_USART_CR1_RXNEIE = USART_CR1_RXNEIE_Msk, /*< Read data register not empty interrupt enable */
	AJ_USART_CR1_TCIE   = USART_CR1_TCIE_Msk,   /*< Transmission complete interrupt enable */
	AJ_USART_CR1_TXEIE  = USART_CR1_TXEIE_Msk,  /*< Transmit data register empty interrupt enable */
	AJ_USART_CR1_PEIE   = USART_CR1_PEIE_Msk,   /*< Parity error interrupt enable */
	AJ_USART_CR1_PCE    = USART_CR1_PCE_Msk,    /*< Parity control enable */
	AJ_USART_CR1_UE     = USART_CR1_UE_Msk      /*< USART enable */
} aj_usart_cr1_state_t;

typedef enum{
	AJ_USART_CR1_WORDLENGTH_8B = 0U,
	AJ_USART_CR1_WORDLENGTH_9B = USART_CR1_M_Msk
} aj_usart_cr1_wordlength_t;

typedef enum{
	AJ_USART_CR1_WAKEUP_IDLELINE = 0U,
	AJ_USART_CR1_WAKEUP_ADDRESSMARK = USART_CR1_WAKE_Msk
} aj_usart_cr1_wakeup_t;

typedef enum{
	AJ_USART_CR1_PARITY_NONE = 0U,
	AJ_USART_CR1_PARITY_EVEN = USART_CR1_PCE_Msk,
	AJ_USART_CR1_PARITY_ODD  = (USART_CR1_PCE_Msk | USART_CR1_PS_Msk)
} aj_usart_cr1_parity_t;

//typedef enum{
//	AJ_USART_CR1_DIRECTION_NONE = 0U,
//	AJ_USART_CR1_DIRECTION_RX   = USART_CR1_RE_Msk,
//	AJ_USART_CR1_DIRECTION_TX   = USART_CR1_TE_Msk,
//	AJ_USART_CR1_DIRECTION_TX_RX = (USART_CR1_TE_Msk | USART_CR1_RE_Msk)
//} aj_usart_cr1_direction_t;

#if defined(USART_CR1_OVER8_Msk)
typedef enum{
	AJ_USART_CR1_OVERSAMPLING_16 = 0U,
	AJ_USART_CR1_OVERSAMPLING_8  = USART_CR1_OVER8_Msk
} aj_usart_cr1_oversampling_t;
#endif
...
typedef enum{
	...
	AJ_USART_CR2_CLKEN  = USART_CR2_CLKEN_Msk,  /*< Clock pin enable */
	AJ_USART_CR2_LINEN  = USART_CR2_LINEN_Msk   /*< LIN mode enable */
} aj_usart_cr2_state_t;

typedef enum{
	AJ_USART_CR2_STOPBITS_1     = 0U,
	AJ_USART_CR2_STOPBITS_0_5   = USART_CR2_STOP_0,
	AJ_USART_CR2_STOPBITS_2     = USART_CR2_STOP_1,
	AJ_USART_CR2_STOPBITS_1_5   = (USART_CR2_STOP_0 | USART_CR2_STOP_1)
} aj_usart_cr2_stopbits_t;

typedef enum{
	AJ_USART_CR2_CLOCK_POLARITY_LOW  = 0U,
	AJ_USART_CR2_CLOCK_POLARITY_HIGH = USART_CR2_CPOL_Msk
} aj_usart_cr2_clock_polarity_t;

typedef enum{
	AJ_USART_CR2_CLOCK_PHASE_1EDGE = 0U,
	AJ_USART_CR2_CLOCK_PHASE_2EDGE = USART_CR2_CPHA_Msk
} aj_usart_cr2_clock_phase_t;

typedef enum{
	AJ_USART_CR2_LIN_BREAK_DETECTION_10B = 0U,
	AJ_USART_CR2_LIN_BREAK_DETECTION_11B = USART_CR2_LBDL_Msk
} aj_usart_cr2_lin_break_detection_t;
