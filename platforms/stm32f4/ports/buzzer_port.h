...
static inline void Buzzer_Pin_ConfigAsOutput(void){
	GPIO_ConfigDirection(BUZZER_GPIO, BUZZER_PIN, GPIO_MODE_OUTPUT);
	GPIO_ConfigOutputType(BUZZER_GPIO, BUZZER_PIN, GPIO_OUTPUT_PUSHPULL);
	GPIO_ConfigOutputSpeed(BUZZER_GPIO, BUZZER_PIN, GPIO_SPEED_2MHZ);
}
