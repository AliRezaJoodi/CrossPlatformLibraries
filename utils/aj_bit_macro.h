...
#define AJ_SET_BITS_MASK(ADDRESS, MASK)             ((ADDRESS) |= (MASK))
#define AJ_SET_BIT_POS(ADDRESS, POS)                ((ADDRESS) |= (0x01UL << (POS)))

#define AJ_CLEAR_BITS_MASK(ADDRESS, MASK)           ((ADDRESS) &= ~(MASK))
#define AJ_CLEAR_BIT_POS(ADDRESS, POS)              ((ADDRESS) &= ~(0x01UL << (POS)))

#define AJ_TOGGLE_BITS_MASK(ADDRESS, MASK)          ((ADDRESS) ^= (MASK))
...
#define AJ_WRITE_2BITS_POS(ADDRESS, POS, VALUE)     ((ADDRESS) = ((ADDRESS) & ~(0x03UL << (POS))) | ((0x03UL & (VALUE)) << (POS)))
#define AJ_WRITE_3BITS_POS(ADDRESS, POS, VALUE)     ((ADDRESS) = ((ADDRESS) & ~(0x07UL << (POS))) | ((0x07UL & (VALUE)) << (POS)))
#define AJ_WRITE_4BITS_POS(ADDRESS, POS, VALUE)     ((ADDRESS) = ((ADDRESS) & ~(0x0FUL << (POS))) | ((0x0FUL & (VALUE)) << (POS)))
#define AJ_WRITE_5BITS_POS(ADDRESS, POS, VALUE)     ((ADDRESS) = ((ADDRESS) & ~(0x1FUL << (POS))) | ((0x1FUL & (VALUE)) << (POS)))
#define AJ_WRITE_6BITS_POS(ADDRESS, POS, VALUE)     ((ADDRESS) = ((ADDRESS) & ~(0x3FUL << (POS))) | ((0x3FUL & (VALUE)) << (POS)))
#define AJ_WRITE_7BITS_POS(ADDRESS, POS, VALUE)     ((ADDRESS) = ((ADDRESS) & ~(0x7FUL << (POS))) | ((0x7FUL & (VALUE)) << (POS)))
#define AJ_WRITE_8BITS_POS(ADDRESS, POS, VALUE)     ((ADDRESS) = ((ADDRESS) & ~(0xFFUL << (POS))) | ((0xFFUL & (VALUE)) << (POS)))
...
#define AJ_GET_2BITS_POS(ADDRESS, POS)              (((ADDRESS) >> (POS)) & 0x03UL)
#define AJ_GET_3BITS_POS(ADDRESS, POS)              (((ADDRESS) >> (POS)) & 0x07UL)
#define AJ_GET_4BITS_POS(ADDRESS, POS)              (((ADDRESS) >> (POS)) & 0x0FUL)
#define AJ_GET_5BITS_POS(ADDRESS, POS)              (((ADDRESS) >> (POS)) & 0x1FUL)
#define AJ_GET_6BITS_POS(ADDRESS, POS)              (((ADDRESS) >> (POS)) & 0x3FUL)
#define AJ_GET_7BITS_POS(ADDRESS, POS)              (((ADDRESS) >> (POS)) & 0x7FUL)
#define AJ_GET_8BITS_POS(ADDRESS, POS)              (((ADDRESS) >> (POS)) & 0xFFUL)
